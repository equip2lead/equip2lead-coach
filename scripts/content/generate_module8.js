...
const section1 = {
  ...
  blocks: [
    ...
    paragraph("A college lacrosse coach inherited a program that had lost consistently for years. Against the odds, a genuine high school standout — recruited aggressively by far stronger programs — was interested in playing for him. The coach met with the young athlete, offered him a scholarship, and expected an easy yes. The player asked for more time instead, willing only to give a non-binding verbal commitment."),
