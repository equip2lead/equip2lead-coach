...
// The pre-module lesson reader, unchanged apart from its name and location.
// /lessons/[id] now decides which of the two content systems an id belongs to
// and renders this one for knowledge_documents. It still reads the id from
// useParams(), so it needs nothing passed in.
export default function LegacyDocumentLesson() {
