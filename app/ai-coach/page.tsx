  ...
  return (
    <div className="h-screen flex flex-col bg-[#F9FAFB]" style={{ fontFamily: "'Outfit', sans-serif" }}>
      ...
      <div className="shrink-0 bg-white border-b border-gray-200 px-6 max-md:px-4 h-16 flex items-center justify-between z-10">
        ...
        <button onClick={() => setLang(l => l === 'en' ? 'fr' : 'en')} className="px-2.5 py-1 rounded-md border border-gray-200 bg-transparent text-[11px] font-semibold text-gray-500 cursor-pointer" style={{ fontFamily: 'inherit' }}>🌐 {lang === 'en' ? 'FR' : 'EN'}</button>
      </div>
