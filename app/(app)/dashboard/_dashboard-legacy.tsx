...
// ARCHIVED 2026-09-06 (Phase 5.3). The dashboard this replaced, kept as a
// reference while the rebuild settles. Not routed and not imported — only
// page.tsx is a route — so it ships nothing. Delete after 30 days of stable
// production.
