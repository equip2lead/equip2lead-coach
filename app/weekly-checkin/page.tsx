    ...
    <div className="min-h-screen bg-[#F9FAFB] flex flex-col" style={{ fontFamily: "'Outfit', sans-serif" }}>
      ...
      <div className="shrink-0 bg-white border-b border-gray-200 px-6 max-md:px-4">
        <div className="h-16 flex items-center justify-between max-w-[640px] mx-auto w-full">
          ...
          <button onClick={() => switchLanguage(lang === 'en' ? 'fr' : 'en', user!.id, supabase, setLang)} className="px-2.5 py-1 rounded-md bg-transparent border-[1.5px] border-gray-200 cursor-pointer text-[11px] font-semibold text-gray-500" style={{ fontFamily: 'inherit' }}>🌐 {t.langLabel}</button>
        </div>
        {/* Progress bar */}
        {step < 5 && (
